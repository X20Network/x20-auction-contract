...
contract('Auction', async (accounts) => {
    it("should execute a big auction with offchain orders correctly", async () => {
        ...
        start = 0; end = 10; await auction.revealBuys(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
        start = 10; end = 20; await auction.revealBuys(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
        start = 20; end = 30; await auction.revealBuys(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
        start = 30; end = 43; await auction.revealBuys(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
        ...
        start = 0; end = 10; await auction.revealSells(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
        start = 10; end = 20; await auction.revealSells(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
        start = 20; end = 30; await auction.revealSells(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
        start = 30; end = 43; await auction.revealSells(token.address, orders.slice(start, end), vs.slice(start, end), rs.slice(start, end), ss.slice(start, end), useReserve);
